      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-xs-12">
            <div class="show-box">
              <img class="img-fulid" src="<?php bloginfo('template_url'); ?>/img/features/feature.png" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div id="portfolio" class="row">
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development print">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php bloginfo('template_url'); ?>/img/portfolio/img1.jpg" alt="" />
                  <a class="overlay lightbox" href="<?php bloginfo('template_url'); ?>/img/portfolio/img1.jpg">
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix design print">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php bloginfo('template_url'); ?>/img/portfolio/img2.jpg" alt="" />
                  <a class="overlay lightbox" href="<?php bloginfo('template_url'); ?>/img/portfolio/img2.jpg">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php bloginfo('template_url'); ?>/img/portfolio/img3.jpg" alt="" />
                  <a class="overlay lightbox" href="<?php bloginfo('template_url'); ?>/img/portfolio/img3.jpg">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development design">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php bloginfo('template_url'); ?>/img/portfolio/img4.jpg" alt="" />
                  <a class="overlay lightbox" href="<?php bloginfo('template_url'); ?>/img/portfolio/img4.jpg">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php bloginfo('template_url'); ?>/img/portfolio/img5.jpg" alt="" />
                  <a class="overlay lightbox" href="<?php bloginfo('template_url'); ?>/img/portfolio/img5.jpg">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix print design">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php bloginfo('template_url'); ?>/img/portfolio/img6.jpg" alt="" />
                  <a class="overlay lightbox" href="<?php bloginfo('template_url'); ?>/img/portfolio/img6.jpg">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php bloginfo('template_url'); ?>/img/team/team1.jpg" alt="">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php bloginfo('template_url'); ?>/img/team/team2.jpg" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php bloginfo('template_url'); ?>/img/team/team3.jpg" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img class="img-fulid" src="<?php bloginfo('template_url'); ?>/img/team/team4.jpg" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-md-12">
            <div class="touch-slider owl-carousel owl-theme">
              <div class="testimonial-item">
                <img src="<?php bloginfo('template_url'); ?>/img/testimonial/customer1.jpg" alt="Client Testimonoal" />
              ...
              <div class="testimonial-item">
                <img src="<?php bloginfo('template_url'); ?>/img/testimonial/customer2.jpg" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Oidila Matik</h3>
              ...
              <div class="testimonial-item">
                <img src="<?php bloginfo('template_url'); ?>/img/testimonial/customer3.jpg" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Alex Dattilo</h3>
              ...
              <div class="testimonial-item">
                <img src="<?php bloginfo('template_url'); ?>/img/testimonial/customer4.jpg" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Paul Kowalsy</h3>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php bloginfo('template_url'); ?>/img/blog/img1.jpg" alt="">
                </a>
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php bloginfo('template_url'); ?>/img/blog/img2.jpg" alt="">
                </a>
              </div>
              <div class="blog-item-text">
                <div class="meta-tags">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php bloginfo('template_url'); ?>/img/blog/img3.jpg" alt="">
                </a>
              </div>
              <div class="blog-item-text">
                <div class="meta-tags">
